...
set VARDIR=%CFGBASEDIR%\var
set ETCDIR=%CFGBASEDIR%\etc
...
cmd /C %BASEDIR%\bin\getlogs.bat --gui-profile=%VARDIR%\CL1prod.txt --hosts=%ETCDIR%\CL1prodHosts.txt --debug=TRACE --ssh-opt="-o ConnectTimeout=300" --ssh-java --prod-base-dir=/logs/gcti/ --log-file=%LOGDIR%\logdown --cfgxml=%ETCDIR%\logbrowser\backend.xml
exit